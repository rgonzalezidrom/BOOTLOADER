# 1 "BootloaderOSC_HS_IDROM.asm"
# 1 "<built-in>" 1
# 1 "BootloaderOSC_HS_IDROM.asm" 2
    radix DEC
...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18.inc" 1 3





# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18_chip_select.inc" 1 3
# 770 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic18f4620.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic18f4620.inc" 3
PORTA equ 0F80h
...
TOSU equ 0FFFh
# 4576 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic18f4620.inc" 3
...
# 770 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18_chip_select.inc" 2 3
# 6 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18.inc" 2 3
...
auto_size SET 0
ENDM
# 5 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\xc.inc" 2 3
# 6 "BootloaderOSC_HS_IDROM.asm" 2

IdTypePIC EQU 0x4F ; must exists in "piccodes.ini"
...
;PIC_response: type `K`
 ...
 ORG 0x10000 ; in BYTES!!! (= 'max flash memory' from "piccodes.ini")-200 ;100 words ;space to deposit first 4 instr. of user prog.
 nop
 nop
 nop
 nop
 org 0x10000 ; in BYTES!!! (= 'max flash memory' from "piccodes.ini")-200 ;100 words+8
IntrareBootloader
        ; init serial port
 movlw b'00100100'
 movwf TXSTA
...
; bra writesloop
waitwre
 ;btfsc EECON1,((EECON1) and 0FFh), 1, a ; for eeprom writes (wait to finish write)
 ;bra waitwre ; no need: round trip time with PC bigger than 4ms

 bcf EECON1,((EECON1) and 0FFh), 2, a ; disable writes
 bra MainLoop
...
Write
 ...
 movlw 0xAA
 movwf EECON2
 bsf EECON1,((EECON1) and 0FFh), 1, a ; WRITE
 nop
 ;nop
 return
...
rpt3
 clrf cnt3
rptc
 btfss PIR1,((PIR1) and 0FFh), 5, a ; test ((PORTC) and 0FFh), 7, a
 bra notrcv
...
notrcv
 ...
 ;timeout:
way_to_exit
 bcf RCSTA,((RCSTA) and 0FFh), 7, a ; deactivate UART
 bra 0x10000 ; in BYTES!!! (= 'max flash memory' from "piccodes.ini")-200 ;100 words
;*************************************************************
; After reset
